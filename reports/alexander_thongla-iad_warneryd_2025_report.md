<table style="border: none;">
  <tr>
    <td width="160" style="border: none;">
      <img src="./images/alexander_warneryd_circle.png" width="140" alt="Alexander Warneryd">
    </td>
...
<p style="margin-bottom: 8px; font-size: 18px; font-weight: bold;">
  📍 Role: Right Wing-Back / Winger
</p>
<p style="margin-top: 0; margin-bottom: 16px; font-size: 18px; font-weight: bold;">
...
<div style="font-size: 14px; color: #333; display: flex; align-items: flex-start; gap: 24px;">
  ...
  <!-- Radar Chart Image -->
  <img src="../figures/offensive_normalized_radar-alexander_thongla-iad_warneryd.png" alt="Offensive Radar Chart" style="max-width: 470px; height: auto; border-radius: 8px;">
</div>
...
<div style="font-size: 14px; color: #333; display: flex; align-items: flex-start; gap: 24px;">
  ...
  <!-- Bar Chart -->
  <img src="../figures/defensive_bar_chart-alexander_thongla-iad_warneryd.png" alt="Offensive Radar Chart" style="max-width: 350px; height: auto; border-radius: 8px;">
</div>
...
<div style="font-size: 14px; color: #333; display: flex; align-items: flex-start; gap: 24px;">
  ...
  <!-- Radar Chart Image -->
  <img src="../figures/creation_radar-alexander_thongla-iad_warneryd.png" alt="Offensive Radar Chart" style="max-width: 350px; height: auto; border-radius: 8px;">
</div>
